...
public class WCDriver {
	...
	public static void main(String[] args) throws Exception {
		//E:\software\java\linux\idea\zte\src\main\resource\mapReduce\input
		Path inputPath=new Path("src/main/resource/mapReduce/input/1.txt");
		Path outputPath=new Path("src/main/resource/mapReduce/output");
